...
const SignUpCard = () => {
  ...
  return (
    <Card className="w-full h-full md:w-121.75 border-none shadow-none">
      <CardHeader className="flex items-center justify-center text-center pt-7 pr-7 pl-7">
        <CardTitle className="text-2xl">Sign Up To Triple</CardTitle>
      </CardHeader>
      <CardDescription className="text-center text-gray-600 text-sm">
        By signing up, you agree to our{" "}
        <span className="text-green-700 font-medium hover:underline transition-colors">
          Terms & Conditions
        </span>
      </CardDescription>
      ...
      <CardContent className="">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid w-full max-w-md items-start gap-4 m-6">
              <Alert>
                <InfoIcon />
                <AlertTitle>
                  This Application Is Made For The Targetak Team
                </AlertTitle>
                <AlertDescription>
                  Please use your name when signing in to get approved.
                </AlertDescription>
              </Alert>
            </div>
